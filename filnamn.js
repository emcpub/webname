...
$(document).ready(function()
{
	...
	
	{
		...
		tempText = '<form action=""><input type="radio" name="codeType" id="BSAB" value="BSAB">BSAB&nbsp;&nbsp;&nbsp;<input type="radio" name="codeType" id="TEXT" value="TEXT"><label id="lbl">Administrativa dokument&nbsp;&nbsp;&nbsp;</label><input type="radio" name="codeType" id="KKS" value="KKS">KKS&nbsp;&nbsp;&nbsp;<input type="radio" name="codeType" id="SSEN" value="SSEN">SSEN</form>';
		$("#s0").html(tempText);
